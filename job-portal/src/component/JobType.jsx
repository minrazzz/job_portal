         ...
         <div class="min-w-120   mx-2">
            <div class="w-full outline-none  border-x-2 border-[#057E01] ">
               ...
               <select
                  ...
                  class="w-full  border-x-2 focus:border-x-2 focus:border-[#057E01]  border-[#057E01]   rounded-md text-[#057E01] shadow-md hover:shadow-lg focus:border-transparent ring-0 focus:ring-0 cursor-pointer"
                  value={cat}
